...
export class Inspector {
  ...
  private _inspectSelection = true
  private _includesOwnProperties = true
  ...
  private _showUnionProperties = false
  private _showLimit = 0
   ...
   */
  constructor(div: HTMLDivElement | null, diagram: go.Diagram, options?: { [index: string]: any }) {
    // const mainDiv = document.getElementById(divid) as HTMLDivElement
    const mainDiv = div as HTMLDivElement
